...
public class VentanaConfiguracion extends JDialog{
    ...
    private JPasswordField tfContraseña;
     ...
     public VentanaConfiguracion() {
        ...
        JLabel lbContraseña = new JLabel("Contarseña:");
        ...
        groupLayout.setHorizontalGroup(
        	groupLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(groupLayout.createSequentialGroup()
        			...
        			.addGap(18)
        			.addComponent(tfContraseña, GroupLayout.PREFERRED_SIZE, 98, GroupLayout.PREFERRED_SIZE)
        			.addContainerGap())
        		.addGroup(groupLayout.createSequentialGroup()
        			.addGap(67)
        ...
        this.pack(); // Le da a la ventana el minimo tamaÃ±o posible
	...
	public String getPassword() {
		return this.tfContraseña.getText();
	}
