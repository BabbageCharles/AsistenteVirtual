...
public class ChuckNorrisFacts {
	...
	public static String facts[] = {
			...
			"El teclado de Chuck Norris tiene dos teclas: 0 y 1",
			"Todos los punteros apuntan a Chuck Norris",
			...
			"Chuck Norris es la razón por la cual Wally se esconde.",
			...
			"Chuck Norris sabe qué tiene Sancor bebé 3.",
			"Chuck Norris puede tocar a la vieja de Pappo.",
			...
			"Chuck Norris puede hacer wheelies con un monociclo.",
			"Chuck Norris puede parsear HTML con regex.",
			...
			"Chuck Norris puede programar con objetos. En Assembler.",
			"Chuck Norris sigue descargando de Megaupload.",
	...
	public static String darFact() {
		String aux = ChuckNorrisFacts.facts[indice];
		indice++;
		if (indice == (facts.length)) {
			indice = 0;
		}
		return aux;
	}
